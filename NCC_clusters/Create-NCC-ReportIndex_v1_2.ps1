# Create-NCC-ReportIndex.ps1 v1.2  Sep 24, 2025
#
...
# --- MODIFICATION: The weekly grouping logic has been removed ---
...
$htmlFoot = @"
    <footer>Index generated by Create-NCC-ReportIndex.ps1 v1.1</footer>
</body>
</html>
"@
