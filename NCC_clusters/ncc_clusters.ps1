# NCC_clusters.ps1 v1.3  Sept 19, 2025
...
foreach ($namecluster in $clusters) {
    ...
    # Define a unique output file for each cluster
    ...
    # --- MODIFICATION: Remove ANSI escape/color codes from the raw output ---
    # The regex matches the escape character followed by sequences used for terminal colors.
    ...
    # Remove the last line if it starts with "Plugin output written to "
