# NCC_clusters.ps1 v1.7  Sept 19, 2025
...
# --- MODIFICATION: Add System.Web assembly for PS 5.1 compatibility ---
...
$htmlFoot = @"
    <footer>Report generated by NCC_clusters.ps1 v1.7</footer>
</body>
</html>
"@
