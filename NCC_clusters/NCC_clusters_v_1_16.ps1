...
<head>
    ...
    <style>
        ...
        pre { background-color: #fff; border: 1px solid #ddd; border-radius: 0 0 5px 5px; padding: 15px; white-space: pre-wrap; word-wrap: break-word; font-family: 'Consolas', 'Monaco', monospace; font-size: 14px; line-height: 1.5; margin-top:0; }
        ...
        .status-zero { color: #6c757d; font-weight: normal; }
