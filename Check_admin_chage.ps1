# Check_admin_chage.ps1 v1.0  August 2025
# This script checks expiration information for 'admin' account on all clusters in clusters.txt 
# This is not a Nutanix Supported script. Do not use to run any config changes or disruptive commnads.
# Usage: .\Check_admin_chage.ps1


# Define paths and variables 
$clusterFile = "D:\Scripts\Nutanix - Run Weekly\Run_commands_all_clusters\clusters.txt" 
...
$AOS_command = "sudo chage -l admin"
...
$outputFile = "D:\Scripts\Nutanix - Run Weekly\Run_commands_all_clusters\admin_chage.txt"
# Setup output file 
